...
public class SearchByTitle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView mylist = findViewById(R.id.listsearchbytitle);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            courses.add(course);
                            CourseListAdapter adapter = new CourseListAdapter(SearchByTitle.this, courses);
                            ...
                            mylist.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
                                    ...
                                    Intent intent=new Intent(SearchByTitle.this,CourseDetails.class);
